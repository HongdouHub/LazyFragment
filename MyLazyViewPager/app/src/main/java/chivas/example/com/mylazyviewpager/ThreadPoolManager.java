...
public class ThreadPoolManager {
     ...
     */
    public void schedule(Runnable runnable, String tag) {
        scheduleDelay(runnable, tag, 0, TimeUnit.SECONDS);
    }
     ...
     * @param unit
     */
    public void scheduleDelay(Runnable runnable, String tag, long delay, TimeUnit unit) {
        if (threadPool != null) {
            ExRunnable exRunnable = new ExRunnable(runnable, tag);
            Future<?> request = ((ScheduledExecutorService) threadPool).schedule(exRunnable, delay, unit);
